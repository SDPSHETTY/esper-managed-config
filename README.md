...
## 4️⃣ QR / Provisioning Payload (JSON)
...
## 5️⃣ Esper API – Get Device Details
...
## 6️⃣ Esper API – Resolve Group by Name
...
## 7️⃣ Esper API – Move Device to Group
